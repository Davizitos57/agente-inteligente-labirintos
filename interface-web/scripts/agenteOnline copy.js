...
export class AgenteOnlineAEstrela {
  ...
  constructor(labirintoReal) {
    ...
    this.contagemVisitas.set(this.inicio, 1);
 ...
 key(estado) {
  ...
  gerarResultado(encontrado, custoOtimoOffline, tempoExecucao) {
    ...
    return ResultadoBuscaOnline(
      ...
      (celulas_reveladas = len(this.celulasReveladas)),
      (celulas_revisitadas = this.celulasRevisitadas),
      (replanejamentos = this.replanejamentos),
